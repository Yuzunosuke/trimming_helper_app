...
//            let imageViewScale = view.frame.height / gridView.frame.height
            ...
            if let trimmedImage = image?.trimming(to: cropRect, zoomedInOutScale: 2.0 / 3.0) {  // zoomedInOutScaleの値がおかしいみたい、何か適切な値があるはず
...
extension CameraTestViewController: UICollectionViewDataSource {
...
extension CameraTestViewController: UICollectionViewDelegate {
